...
public class BPTFRecommender extends TensorRecommender {
     ...
     */
    protected void sampleModelParameters(DenseVector mu, DenseMatrix lambda, List<SparseMatrix> trainMatrices, double alpha, boolean isUserUpdate) {
     ...
     */
    protected void sampleTimeParameters(DenseVector mu, DenseMatrix lambda, List<SparseMatrix> trainMatrices, double alpha) {
